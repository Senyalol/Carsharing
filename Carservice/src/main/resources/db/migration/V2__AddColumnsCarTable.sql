...
INSERT INTO cars (make,model,year,license_plate,availability,location,photo_url,engine_type,number_of_seats,weight,engine_volume,max_speed,gearbox_type)
